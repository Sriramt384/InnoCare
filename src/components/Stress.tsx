...
const StressDataChart: React.FC = () => {
  ...
  useEffect(() => {
    const options: ApexOptions = {
      series: [
        {
          name: 'Stress Level',
          data: [
            30, 32, 34, 35, 40, 38, 41, 39, 45, 50, 48, 44, 42, 39, 37, 35, 36, 40, 45, 48, 46, 47, 50, 52, 55, 58, 60, 62, 61, 59, 57,
          ],
        },
      ],
      chart: {
      ...
      xaxis: {
        ...
        tickAmount: 10,
        labels: {
          formatter: (_value: string, timestamp: number, opts: any) => {
